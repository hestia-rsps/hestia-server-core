...
object ClientOpcodes {
    ...
    const val WIDGET_OPTION_6 = 18
    const val PLAYER_OPTION_10 = 19
    const val WIDGET_OPTION_10 = 20
    const val WIDGET_ON_FLOOR_ITEM = 21
    const val COLOUR_ID = 22
    const val CHAT_TYPE = 23
    const val FLOOR_ITEM_OPTION_3 = 24
    const val WIDGET_OPTION_8 = 25
    const val SWITCH_WIDGET_COMPONENTS = 26
    ...
    const val WIDGET_OPTION_1 = 61
    const val PLAYER_OPTION_8 = 62
    const val OTHER_TELEPORT = 63
    const val WIDGET_OPTION_2 = 64
    const val WIDGET_ON_MOB = 65
    ...
    const val WIDGET_PLAYER_BODY = 18//TODO("Test")
    ...
    const val WIDGET_TILE_TEXT = 32//TODO("Test")
    ...
    const val WIDGET_ITEMS_UPDATE = 80
    ...
    const val CHAT = 102
    const val WIDGET_COMPONENT_POSITION = 104//TODO("Test")
    const val IGNORE_LIST_UPDATE = 105
    const val WIDGET_PLAYER_OTHER_BODY = 109//TODO("Test")
    const val GLOBAL_CONFIG = 111
    const val GLOBAL_CONFIG_LARGE = 112
    const val WIDGET_PLAYER_HEAD = 114
    const val WIDGET_COMPONENT_VISIBILITY = 117//TODO("Test")
    const val PRIVATE_CHAT_FROM = 120
    const val WIDGET_COMPONENT_ORIENTATION = 122//TODO("Test")
